  ...
  const handleQuoteSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/bhakarsousbh@gmail.com",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...formData,
            _subject: `New Quote Request for ${formData.product || "Product"}`,
            _template: "table",
            _autoresponse: `Thank you for your quote request regarding ${formData.product}. We've received your details and will get back to you within 24 hours.`,
            _captcha: "false",
          }),
        }
      );
                ...
                <form className="space-y-4" onSubmit={handleQuoteSubmit}>
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      } text-white py-2 px-4 rounded-md transition-colors duration-300 font-medium flex items-center justify-center gap-2`}
                    >
                      {isSubmitting ? (
                        <>
                          <svg
