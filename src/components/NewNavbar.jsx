...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-r from-white to-green-950 text-white py-4 px-6 shadow-md sticky top-0  z-50 backdrop-blur-md bg-opacity-95">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div ref={searchRef} className="relative">
            <button
              ...
              className="p-2 rounded-full  text-green-800 hover:bg-white transition-colors duration-200"
            >
              <svg
          ...
          <button
            ...
            className="bg-green text-gray-300 hover:bg-gray-500 px-4 py-2 rounded-full font-medium transition-all duration-300 shadow-sm hover:shadow-md flex items-center gap-2 border border-gray-200 hover:border-gray-300"
          >
            <svg
              className="w-4 h-4"
              fill="none"
        ...
        <div className="hidden md:flex gap-4 items-center justify-end">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-2.717 0-4.92 2.203-4.92 4.917 0 .39.045.765.127 1.124-4.087-.205-7.719-2.165-10.141-5.144-.424.729-.666 1.574-.666 2.475 0 1.708.87 3.216 2.188 4.099-.807-.026-1.566-.247-2.229-.616v.062c0 2.385 1.698 4.374 3.946 4.828-.413.111-.849.228-1.296.326.326 1.018 1.272 1.863 2.397 1.885-2.203 1.727-4.976 2.755-7.994 2.755-.518 0-1.028-.03-1.531-.087 2.828 1.812 6.188 2.873 9.791 2.873 11.745 0 18.17-9.726 18.17-18.17 0-.277-.006-.553-.019-.828 1.248-.899 2.332-2.021 3.188-3.295z" />
            </svg>
          </a>
          <a
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.326 3.608 1.301.975.975 1.24 2.242 1.301 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.326 2.633-1.301 3.608-.975.975-2.242 1.24-3.608 1.301-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.326-3.608-1.301-.975-.975-1.24-2.242-1.301-3.608-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.062-1.366.326-2.633 1.301-3.608.975-.975 2.242-1.24 3.608-1.301 1.266-.058 1.646-.07 4.85-.07zm0-2.163c-3.259 0-3.667.014-4.947.072-1.627.073-3.355.414-4.632 1.691-1.277 1.277-1.618 3.005-1.691 4.632-.058 1.28-.072 1.688-.072 4.947s.014 3.667.072 4.947c.073 1.627.414 3.355 1.691 4.632 1.277 1.277 3.005 1.618 4.632 1.691 1.28.058 1.688.072 4.947.072s3.667-.014 4.947-.072c1.627-.073 3.355-.414 4.632-1.691 1.277-1.277 1.618-3.005 1.691-4.632.058-1.28.072-1.688.072-4.947s-.014-3.667-.072-4.947c-.073-1.627-.414-3.355-1.691-4.632-1.277-1.277-3.005-1.618-4.632-1.691-1.28-.058-1.688-.072-4.947-.072zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.162 6.162 6.162 6.162-2.759 6.162-6.162-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.791-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.441s.645 1.441 1.441 1.441 1.441-.645 1.441-1.441-.645-1.441-1.441-1.441z" />
            </svg>
          </a>
        </div>
      </div>
