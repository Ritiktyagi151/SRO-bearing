...
const CategoryIcon = () => (
  <svg viewBox="0 0 1024 1024" className="w-8 h-8" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M838.5 772.8c-2.4 0-4.9-0.9-6.8-2.7L668.1 618.7c-4.1-3.8-4.3-10.1-0.5-14.1 3.8-4.1 10.1-4.3 14.1-0.5l163.6 151.4c4.1 3.8 4.3 10.1 0.5 14.1-2 2.1-4.7 3.2-7.3 3.2z" fill="#34d399" />
  </svg>
);
...
const ProductIcon = () => (
  <svg viewBox="0 0 1024 1024" className="w-8 h-8" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M887.4 269.9l-26.3 8.7c-36.5 12-139.1 43.3-174.7 43.3-35.5 0-137.8-31.3-174.3-43.3l-0.5-0.2c-13.9-4.2-137.6-40.8-183.7-40.8-47.5 0-175.2 36.6-189.6 40.8l-14.4 4.2V831l25.6-7.5c37.1-10.9 141.2-39.2 176.1-39.2 34.5 0 137.5 28.2 174.5 39.1 15.7 4.9 145.9 45.2 198.2 45.2h1.6c45.3-0.8 161.1-40.9 174.2-45.4l13.4-4.7-0.1-548.6zM511.8 785.2l-0.3-0.1c-14.1-4.2-139.4-40.8-186-40.8-36 0-118.8 21.6-161.7 33.5V312.7c45.2-12.6 132.5-35.1 164.1-35.1 34 0 135.4 28.1 171.9 39.1 15.3 5 138.6 45.2 186.6 45.2 36.9 0 118.2-23.6 160.9-36.9v465c-40.8 13.7-118.9 38.1-148.2 38.6-38 0.6-148.1-31.1-187.3-43.4z" fill="#2563eb" />
    ...
    <path d="M861.5 186c-37.3-37.1-87-57.5-139.8-57.5-109.4 0-198.4 89-198.4 198.4 0 84.8 53.9 160.2 134 187.7 6.5 3.4 25.6 24.9 46.5 55.3 4 5.9 10.7 9.3 17.8 9.3h0.3c7.2-0.1 13.9-3.8 17.8-9.8 19-29.2 36.5-50 42.8-53.7 39.2-12.6 74.3-37.9 98.9-71.2 25.6-34.7 39-75.9 38.6-119.1-0.4-52.8-21.1-102.3-58.5-139.4zM670.6 476.9C606.4 455 563.3 394.8 563.3 327c0-87.3 71-158.4 158.4-158.4 86.7 0 157.7 70.5 158.4 157.2 0.5 69.9-43.8 131-110.3 152.1-4.9 1.6-18.5 5.9-48.5 47.8-3.1-4.1-6.5-8.5-10-12.8-22.2-27.2-33.4-33.5-40.7-36z" fill="#2563eb" />
    <path d="M797.4 405.3c-2.4 0-4.8-0.9-6.7-2.6-4.1-3.7-4.4-10-0.7-14.1 15.5-17.1 23.9-39.3 23.8-62.5-0.4-50.4-41.7-91.4-92.1-91.4-12.8 0-25.2 2.6-36.8 7.6-5.1 2.2-11-0.1-13.2-5.2-2.2-5.1 0.1-11 5.2-13.2 14.2-6.2 29.2-9.3 44.8-9.3 29.9 0 57.9 11.5 79 32.5 21.1 20.9 32.8 48.9 33.1 78.8 0.2 28.2-10.1 55.2-28.9 76-2.1 2.3-4.8 3.4-7.5 3.4z" fill="#60a5fa" />
  </svg>
);

const BlogIcon = () => (
  <svg viewBox="0 0 1024 1024" className="w-8 h-8" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <path d="M325.8 819.6h-55c-38.6 0-70-31.4-70-70V510.1c0-38.6 31.4-70 70-70h55c38.6 0 70 31.4 70 70v239.5c0 38.6-31.4 70-70 70z m-54.9-339.5c-16.5 0-30 13.5-30 30v239.5c0 16.5 13.5 30 30 30h55c16.5 0 30-13.5 30-30V510.1c0-16.5-13.5-30-30-30h-55z" fill="#d97706" />
    <path d="M834.8 177.7h-55c-16.5 0-30 13.5-30 30v541.9c0 16.5 13.5 30 30 30h55c16.5 0 30-13.5 30-30V207.7c0-16.5-13.5-30-30-30zM580.3 300.7h-55c-16.5 0-30 13.5-30 30v418.9c0 16.5 13.5 30 30 30h55c16.5 0 30-13.5 30-30V330.7c0-16.5-13.5-30-30-30zM325.8 479.7h-55c-16.5 0-30 13.5-30 30v239.9c0 16.5 13.5 30 30 30h55c16.5 0 30-13.5 30-30V509.7c0-16.5-13.4-30-30-30z" fill="#e5e7eb" />
    <path d="M834.8 137.7h-55c-38.6 0-70 31.4-70 70v207.9c-18.3-8.6-38.4-14.2-59.5-16v-68.8c0-38.6-31.4-70-70-70h-55c-38.6 0-70 31.4-70 70v418.9c0 38.6 31.4 70 70 70h55c38.2 0 69.3-30.7 70-68.7 21.1-1.8 41.2-7.4 59.5-16v14.7c0 38.6 31.4 70 70 70h55c38.6 0 70-31.4 70-70v-542c0-38.6-31.5-70-70-70z m-85 364c13.6 21.2 21.5 46.4 21.5 73.5 0 27-7.9 52.2-21.5 73.5v-147z m-251.2 73.5c0-66.8 48.2-122.5 111.7-134.1v268.2c-63.5-11.6-111.7-67.3-111.7-134.1z m26.7-274.5h55c16.5 0 30 13.5 30 30v69.9c-46.6 6.6-87.4 31.4-115 67V330.7c0-16.5 13.5-30 30-30z m55 478.9h-55c-16.5 0-30-13.5-30-30v-66.8c27.5 35.6 68.3 60.5 115 67-0.1 16.5-13.5 29.8-30 29.8z m70-68.9v-271c21.8 2.4 42 10 59.5 21.6v227.9c-17.5 11.5-37.7 19.1-59.5 21.5z m99.5 38.9v-16.9l46.6 46.9h-16.6c-16.6 0-30-13.4-30-30z m115 0c0 11.3-6.3 21.2-15.6 26.3l-82.8-83.2c27.9-31.2 44.9-72.4 44.9-117.5 0-53.4-23.9-101.4-61.5-133.7V207.7c0-16.5 13.5-30 30-30h55c16.5 0 30 13.5 30 30v541.9zM892.2 881.3h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-50 0h-10c-5.5 0-10-4.5-10-10s4.5-10 10-10h10c5.5 0 10 4.5 10 10s-4.4 10-10 10z m-14.4-35.6c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z m0-50c-5.5 0-10-4.5-10-10v-10c0-5.5 4.5-10 10-10s10 4.5 10 10v10c0 5.5-4.5 10-10 10z" fill="#d97706" />
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const [cats, prods, blogs, contacts, webs] = await Promise.all([
          apiGet("/categories"),
          apiGet("/products"),
          apiGet("/blogs"),
  ...
  const statCards = [
    {
      ...
      icon: CategoryIcon,
      iconColor: "from-emerald-400 to-teal-500 shadow-md shadow-emerald-500/20",
      hoverBorder: "hover:border-emerald-400 hover:shadow-lg hover:shadow-emerald-500/5",
    },
    {
      name: "Total Products",
      ...
      hoverBorder: "hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/5",
    },
    {
      name: "Blog Posts",
      value: stats.blogs,
      ...
      hoverBorder: "hover:border-amber-400 hover:shadow-lg hover:shadow-orange-500/5",
    },
    {
      ...
      hoverBorder: "hover:border-rose-400 hover:shadow-lg hover:shadow-rose-500/5",
    },
    {
      ...
      hoverBorder: "hover:border-purple-400 hover:shadow-lg hover:shadow-purple-500/5",
    },
  ];
  ...
  return (
    <AdminLayout>
      ...
      <div className="space-y-8 font-sans">
        {/* Welcome Banner */}
        <div className="relative bg-gradient-to-r from-green-50 to-emerald-50/50 rounded-2xl p-8 border border-green-200 overflow-hidden shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="absolute top-0 right-0 translate-x-12 -translate-y-12 w-64 h-64 bg-green-500/5 rounded-full blur-[80px]" />
          <div className="flex-1 space-y-3 z-10">
            ...
            <p className="text-gray-650 max-w-xl text-sm leading-relaxed">
              Manage your product inventory, organize web dropdown nav bars, modify
              landing section headers, and respond directly to customer inquiries.
            </p>
          </div>
          <div className="flex-shrink-0 z-10 w-full md:w-auto flex justify-center">
            {/* Premium Open-Source Dashboard & Bearing Illustration */}
            <svg viewBox="0 0 500 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[280px] h-auto drop-shadow-md">
              <path d="M50 280L450 280" stroke="#E2E8F0" strokeWidth="2" strokeDasharray="4 4"/>
              <path d="M50 200L450 200" stroke="#E2E8F0" strokeWidth="2" strokeDasharray="4 4"/>
              <path d="M50 120L450 120" stroke="#E2E8F0" strokeWidth="2" strokeDasharray="4 4"/>

              {/* Analytics bar charts */}
              <rect x="90" y="140" width="32" height="140" rx="6" fill="url(#grad1)" />
              <rect x="160" y="80" width="32" height="200" rx="6" fill="url(#grad2)" />
              <rect x="230" y="110" width="32" height="170" rx="6" fill="url(#grad1)" />
              <rect x="300" y="60" width="32" height="220" rx="6" fill="url(#grad2)" />
              <rect x="370" y="160" width="32" height="120" rx="6" fill="url(#grad1)" />

              {/* Smooth trend line */}
              <path d="M106 130 Q 176 60, 246 100 T 386 150" fill="none" stroke="#059669" strokeWidth="4" strokeLinecap="round"/>
              <circle cx="386" cy="150" r="6" fill="#10B981" stroke="#FFFFFF" strokeWidth="2"/>
              <circle cx="106" cy="130" r="6" fill="#10B981" stroke="#FFFFFF" strokeWidth="2"/>

              {/* Rotating Gear / Bearing illustration (theme match) */}
              <g transform="translate(430, 60)">
                <circle cx="0" cy="0" r="28" fill="none" stroke="#10B981" strokeWidth="5" strokeDasharray="8 5"/>
                <circle cx="0" cy="0" r="16" fill="none" stroke="#059669" strokeWidth="3.5"/>
                <circle cx="0" cy="0" r="5" fill="#047857"/>
              </g>
              <g transform="translate(455, 95)">
                <circle cx="0" cy="0" r="18" fill="none" stroke="#9CA3AF" strokeWidth="3" strokeDasharray="6 3"/>
                <circle cx="0" cy="0" r="10" fill="none" stroke="#4B5563" strokeWidth="2.5"/>
                <circle cx="0" cy="0" r="3" fill="#374151"/>
              </g>

              {/* Dashboard floating UI card */}
              <g transform="translate(60, 30)">
                <rect width="150" height="60" rx="10" fill="#FFFFFF" filter="drop-shadow(0px 4px 6px rgba(0, 0, 0, 0.05))"/>
                <rect width="150" height="60" rx="10" stroke="#E5E7EB" strokeWidth="1"/>
                <circle cx="25" cy="30" r="12" fill="#ECFDF5"/>
                <path d="M21 30L24 33L29 27" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="46" y="20" width="80" height="6" rx="3" fill="#9CA3AF"/>
                <rect x="46" y="34" width="50" height="5" rx="2.5" fill="#E5E7EB"/>
              </g>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {statCards.map((card) => (
              ...
              >
                ...
                <div
                  className="w-14 h-14 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:bg-white group-hover:border-gray-200"
                >
                  <card.icon />
                </div>
              </div>
