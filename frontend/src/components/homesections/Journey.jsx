        ...
        >
          ...
          <div className="absolute  -left-72 inset-0 -translate-y-1/2 ml-6 w-72 sm:w-80 text-left">
            <div className="grid grid-cols-2 gap-x-6 gap-y-3">
              {about && about.stats && about.stats.length > 0 ? (
                ...
                <>
                  ...
                  <div className="text-left">
                    <span className="text-2xl font-bold text-[#039748]">38 000</span>
                  ...
                  {/* Stat 4 */}
                  <div className="text-left">
                    <span className="text-2xl font-bold text-[#039748]">&gt; 17 000</span>
