...
const NewsSlider = () => {
  ...
  const newsItems = blogs.length > 0 ? blogs : [
    {
      id: 1,
  ...
  const getBlogImage = (item) => {
    if (!item.image) return "https://images.unsplash.com/photo-1503507739298-dce173d09653?w=600";
                        ...
                        >
                          ...
                          <div className="p-6">
                            ...
                            <p className="text-sm text-gray-500 mb-2">
                              {news.location ? `${news.location}, ` : ""}{formatDate(news.date || news.createdAt)}
                            </p>
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-[#00984C] hover:text-green-800 text-sm font-medium transition-colors">
                                Read more →
                              </span>
                            </div>
                          </div>
