...
const SROBearingsSection = ({ about = {} }) => {
  return (
    <div>
      <div className="h-[85px] w-[100%] bg-gray-600"></div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-12">
              <p className="text-gray-400 text-lg max-w-xl">
                {about.greetingsContent || "Spherical Roller Bearings are designed to accommodate heavy radial and axial loads, while compensating for shaft misalignment. Ideal for demanding applications like mining, power generation, and heavy industry."}
              </p>
            </div>
          </div>
